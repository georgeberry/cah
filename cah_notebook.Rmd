...
plot_lost_friends = ggplot(lost_friends_demos) +
  geom_col() +
  aes(x=reorder(demo, lost_friends), y=lost_friends, fill = groupname_short) +
  geom_linerange(aes(x=reorder(demo, lost_friends), ymin=lost_friends_min, ymax=lost_friends_max)) +
...
plot_civil_war = ggplot(civil_war_demos) +
  geom_col() +
  aes(x=reorder(demo, civil_war), y=civil_war, fill = groupname_short) +
  geom_linerange(aes(x=reorder(demo, civil_war), ymin=civil_war_min, ymax=civil_war_max)) +
  # geom_hline(yintercept=0, linetype='dotdash') +
  # geom_hline(yintercept=1, linetype='dotdash') +
  ylim(c(0, 1)) +
  scale_fill_discrete(guide = 'none') +
